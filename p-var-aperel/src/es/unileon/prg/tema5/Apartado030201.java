 ...
 */
    ...
    */
	...
	char caracterIntermedio=cadena.charAt(medio);
	int posicion;
	posicion=cadena.indexOf('d', 12);


	System.out.println(cadena.length());
	System.out.println("El caracter intermedio es:"+ caracterIntermedio);
    ...
    */
	...
	if (cadena.equalsIgnoreCase(otraCadena)==true){
	System.out.println("Las dos cadenas son iguales");
		}else {
			System.out.println("Las dos cadenas no son iguales");		
	}
	...
	String cadena2 = otraCadena.toLowerCase();
    ...
    */
	...
	System.out.println("si contiene la palabra parnaso");
	}

	if(cadena.startsWith("Viaje")){
	System.out.println("si contiene la palabra Viaje");
	}
